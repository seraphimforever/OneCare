...
/* ------------------------------
   Save forms
   NOTE: this only shows a confirmation toast — it does not persist
   anything anywhere. Pages that need real persistence (e.g. profile.html)
   should call the appropriate database.js function directly instead of
   relying on this.
-------------------------------- */
